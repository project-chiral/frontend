...
- [x] 配置 Vite + React + TypeScript (已完成)
- [x] 配置 Tailwind CSS 4.x (已完成)
- [x] 配置 ESLint 规则 (已完成)
- [x] 配置 Prettier 代码格式化 (已完成)
- [x] 配置 HMR 热更新 (已完成)

### 1.2 状态管理

- [x] 配置 Zustand 全局 store (已完成)
- [x] 配置 Zustand workspace store (已完成)
- [x] 实现组件作用域 store 模式 (已完成，React 组件天然隔离，无需额外模式)
- [x] 迁移 Vue createStore 模式 (已完成，React 使用更简单的 props/global store 模式)

### 1.3 数据获取层

- [x] 配置 TanStack Query v5 (已完成)
- [x] 配置 query keys 规范 (已完成)
- [x] 迁移 Vue Query hooks 到 React (已完成)

### 1.4 路由系统

- [x] 配置 React Router v6 (已完成)
- [x] 实现嵌套路由结构 (已完成)
- [x] 实现懒加载模式 (已完成)
...
- [x] 配置 shadcn/ui (已完成)
- [x] 安装基础组件: Button, Input, Label, Card, Select (已完成)
- [x] 安装 Dialog, Dropdown, Tabs, ScrollArea, Tooltip, Popover, Separator (已完成)
- [x] 配置深色模式主题 (已完成)
- [x] 配置 Tailwind CSS 主题变量 (已完成)
